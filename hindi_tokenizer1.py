...
class Tokenizer():
    ...
    def print_finalSentence(self, x):
        fileName = 'C:\\Users\\geeta\\PycharmProjects\\summarizer\\new_complete_corpus\\machine_output\\tokenized' + str(x) + ".txt"
...
if __name__ == "__main__":
    for x in range(1, 76):
        t = Tokenizer()
        filePath = 'C:\\Users\\geeta\\PycharmProjects\\summarizer\\new_complete_corpus\\input\\'
